<?php
			...
			if(in_array($this->upload_filetype,$this->allow_uploadedfile_type))
			{
				if($this->upload_file_size < $this->allow_uploaded_maxsize)
				{
					...
					include("./source/image.class.php");
  					...
  					$image->reImg($this->upload_target_path,200,200,80,$id,$table);
			...
			if(in_array($this->upload_filetype,$this->allow_uploadedfile_type))
			{
				if($this->upload_file_size < $this->allow_uploaded_maxsize)
				{
					...
					include("./source/image.class.php");
  					...
  					$image->reImg1($this->upload_target_path,60,60,80,$id,$table);
			...
			if(in_array($this->upload_filetype,$this->allow_uploadedfile_type))
			{
				if($this->upload_file_size < $this->allow_uploaded_maxsize)
				{
					...
					include("./source/image.class.php");
  					...
  					$image->reImg2($this->upload_target_path,700,320,80,$id,$table);
	...
	function upload_file3($id,$table)
		{   
			if(!empty($this->upload_filetype)){
			if(in_array($this->upload_filetype,$this->allow_uploadedfile_type))
			{
				if($this->upload_file_size < $this->allow_uploaded_maxsize)
				{
					...
					include("./source/image.class.php");
  					...
  					$image->reImg3($this->upload_target_path,123,125,80,$id,$table);
