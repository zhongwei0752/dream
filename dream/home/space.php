...
//允许动作
$dos = array('feed', 'doing', 'mood', 'blog', 'album', 'thread', 'mtag', 'friend', 'wall', 'tag', 'notice', 'share', 'topic', 'home', 'pm', 'event', 'poll', 'top', 'info', 'videophoto','dream','test','timer','medicine','activity','group','discussion','text','joke','news','littlenews','subject','othersubject');
