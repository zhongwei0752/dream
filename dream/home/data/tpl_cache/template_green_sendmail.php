<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/sendmail', '1368871252', 'template/green/sendmail');?><table cellspacing="0" cellpadding="20">
<tr><td>
