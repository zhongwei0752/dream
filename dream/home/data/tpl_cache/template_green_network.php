<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/network|template/green/header|template/green/footer', '1369984659', 'template/green/network');?><?php $_TPL['nosidebar']=1; ?>
