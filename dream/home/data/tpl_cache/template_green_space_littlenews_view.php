<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_littlenews_view|template/green/header|template/green/space_menu|template/green/space_click|template/green/space_comment_li|template/green/footer', '1369412856', 'template/green/space_littlenews_view');?><?php $_TPL['titles'] = array($littlenews['subject'], '一句话新闻'); ?>
...
<?php if($space['self']) { ?>
<h2 class="title"><img src="image/app/littlenews.gif" />一句话新闻</h2>
<div class="tabs_header">
<ul class="tabs">
<li class="active"><a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=me"><span>我的一句话新闻</span></a></li>
</ul>
...
<?php } else { ?>
<?php $_TPL['spacetitle'] = "一句话新闻";
	$_TPL['spacemenus'][] = "<a href=\"space.php?uid=$space[uid]&do=$do&view=me\">TA的所有一句话新闻</a>";
	$_TPL['spacemenus'][] = "<a href=\"space.php?uid=$space[uid]&do=littlenews&id=$littlenews[littlenewsid]\">查看一句话新闻</a>"; ?>
...
<div class="title">
<h1<?php if($littlenews['magiccolor']) { ?> class="magiccolor<?=$littlenews['magiccolor']?>"<?php } ?>><?=$littlenews['subject']?></h1>
<?php if($littlenews['friend']) { ?>
<span class="r_option locked gray"><?=$friendsname[$littlenews['friend']]?></span>
<?php } ?>
<?php if($littlenews['hot']) { ?><span class="hot"><em>热</em><?=$littlenews['hot']?></span><?php } ?>
<?php if($littlenews['friend']) { ?>
<span class="r_option locked gray">
<a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=me&friend=<?=$littlenews['friend']?>" class="gray"><?=$friendsname[$value['friend']]?></a>
</span>
<?php } ?>
<?php if($littlenews['viewnum']) { ?><span class="gray">已有 <?=$littlenews['viewnum']?> 次阅读</span><?php } ?>
&nbsp; <span class="gray"><?php echo sgmdate('Y-m-d H:i',$littlenews[dateline],1); ?></span>
<?php if($littlenews['tag']) { ?>
&nbsp; <a href="space.php?uid=<?=$littlenews['uid']?>&do=tag">标签</a>:&nbsp;
<?php if(is_array($littlenews['tag'])) { foreach($littlenews['tag'] as $tagid => $tagname) { ?>
<a href="space.php?uid=<?=$littlenews['uid']?>&do=tag&id=<?=$tagid?>"><?=$tagname?></a>&nbsp;
<?php } } ?>
<?php } ?>
</div>


<div id="littlenews_article" class="article <?php if($littlenews['magicpaper']) { ?> magicpaper<?=$littlenews['magicpaper']?><?php } ?>">
<div class="resizeimg">
...
<a href="cp.php?ac=share&type=littlenews&id=<?=$littlenews['littlenewsid']?>" id="a_share" onclick="ajaxmenu(event, this.id, 1)" class="a_share">分享</a>

<?php if($_SGLOBAL['supe_uid'] == $littlenews['uid']) { ?>
<?php if($_SGLOBAL['magic']['bgimage']) { ?>
<img src="image/magic/bgimage.small.gif" class="magicicon">
<?php if($littlenews['magicpaper']) { ?>
<a href="cp.php?ac=magic&op=cancelbgimage&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_bgimage" onclick="ajaxmenu(event,this.id, 1)">取消<?=$_SGLOBAL['magic']['bgimage']?></a>
<?php } else { ?>
<a href="magic.php?mid=bgimage&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_bgimage" onclick="ajaxmenu(event,this.id, 1)"><?=$_SGLOBAL['magic']['bgimage']?></a>	
<?php } ?>
<?php } ?>
<?php if($_SGLOBAL['magic']['call']) { ?>
<img src="image/magic/call.small.gif" class="magicicon">
<a href="magic.php?mid=call&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_call" onclick="ajaxmenu(event,this.id, 1)"><?=$_SGLOBAL['magic']['call']?></a>
<?php } ?>
<?php if($_SGLOBAL['magic']['updateline']) { ?>
<img src="image/magic/updateline.small.gif" class="magicicon">
<a href="magic.php?mid=updateline&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_updateline" onclick="ajaxmenu(event,this.id, 1)"><?=$_SGLOBAL['magic']['updateline']?></a>
<?php } ?>
<?php if($_SGLOBAL['magic']['downdateline']) { ?>
<img src="image/magic/downdateline.small.gif" class="magicicon">
<a href="magic.php?mid=downdateline&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_downdateline" onclick="ajaxmenu(event,this.id, 1)"><?=$_SGLOBAL['magic']['downdateline']?></a>
<?php } ?>
<?php if($_SGLOBAL['magic']['color']) { ?>
<img src="image/magic/color.small.gif" class="magicicon">
<?php if($littlenews['magiccolor']) { ?>
<a href="cp.php?ac=magic&op=cancelcolor&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_color" onclick="ajaxmenu(event,this.id)">取消<?=$_SGLOBAL['magic']['color']?></a>
<?php } else { ?>
<a href="magic.php?mid=color&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_color" onclick="ajaxmenu(event,this.id, 1)"><?=$_SGLOBAL['magic']['color']?></a>
<?php } ?>
<?php } ?>
<?php if($_SGLOBAL['magic']['hot']) { ?>
<img src="image/magic/hot.small.gif" class="magicicon">
<a href="magic.php?mid=hot&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_magic_hot" onclick="ajaxmenu(event,this.id, 1)"><?=$_SGLOBAL['magic']['hot']?></a>
<?php } ?>
<span class="pipe">|</span>
<?php } ?>

<?php if($_SGLOBAL['supe_uid'] == $littlenews['uid'] || checkperm('managelittlenews')) { ?>
<a href="cp.php?ac=topic&op=join&id=<?=$littlenews['littlenewsid']?>&idtype=littlenewsid" id="a_topicjoin_<?=$littlenews['littlenewsid']?>" onclick="ajaxmenu(event, this.id)">凑热闹</a><span class="pipe">|</span>
<a href="cp.php?ac=littlenews&littlenewsid=<?=$littlenews['littlenewsid']?>&op=edit">编辑</a><span class="pipe">|</span>
<a href="cp.php?ac=littlenews&littlenewsid=<?=$littlenews['littlenewsid']?>&op=delete" id="littlenews_delete_<?=$littlenews['littlenewsid']?>" onclick="ajaxmenu(event, this.id)">删除</a><span class="pipe">|</span>
<?php } ?>
<?php if(checkperm('managelittlenews')) { ?>
<a href="cp.php?ac=littlenews&littlenewsid=<?=$littlenews['littlenewsid']?>&op=edithot" id="littlenews_hot_<?=$littlenews['littlenewsid']?>" onclick="ajaxmenu(event, this.id)">热度</a><span class="pipe">|</span>
<?php } ?>
<a href="cp.php?ac=common&op=report&idtype=littlenewsid&id=<?=$littlenews['littlenewsid']?>" id="a_report" onclick="ajaxmenu(event, this.id, 1)">举报</a>
</div>
...
<h2>
<?php if(!$littlenews['noreply']) { ?>
<a href="#quickcommentform_<?=$id?>" class="r_option">发表评论</a>
<?php } ?>
评论 (<span id="comment_replynum"><?=$littlenews['replynum']?></span> 个评论)</h2>
<div class="page"><?=$multi?></div>
<div class="comments_list" id="comment">
<?php if($cid) { ?>
<div class="notice">
当前只显示与你操作相关的单个评论，<a href="space.php?uid=<?=$littlenews['uid']?>&do=littlenews&id=<?=$littlenews['littlenewsid']?>">点击此处查看全部评论</a>
</div>
<?php } ?>
<ul id="comment_ul">
...
<tr>
<td>
<input type="hidden" name="refer" value="space.php?uid=<?=$littlenews['uid']?>&do=<?=$do?>&id=<?=$id?>" />
<input type="hidden" name="id" value="<?=$id?>">
<input type="hidden" name="idtype" value="littlenewsid">
...
<div class="sidebox">
<h2 class="title">
<a href="space.php?uid=<?=$littlenews['uid']?>&do=littlenews&view=me" class="r_option">全部</a>
作者的其他最新一句话新闻
</h2>
<ul class="littlenews_list">
<?php if(is_array($otherlist)) { foreach($otherlist as $value) { ?>
<li style="height:auto;"><a href="space.php?uid=<?=$value['uid']?>&do=littlenews&id=<?=$value['littlenewsid']?>"><?=$value['subject']?></a></li>
<?php } } ?>
</ul>
</div>
<?php } ?>
...
<?php if($newlist) { ?>
<div class="sidebox">
<h2 class="title">热门一句话新闻导读</h2>
<ul class="littlenews_list">
<?php if(is_array($newlist)) { foreach($newlist as $value) { ?>
<li style="height:auto;"><a href="space.php?uid=<?=$value['uid']?>" style="font-weight:bold;"><?=$_SN[$value['uid']]?></a>: <a href="space.php?uid=<?=$value['uid']?>&do=littlenews&id=<?=$value['littlenewsid']?>"><?=$value['subject']?></a></li>
<?php } } ?>
</ul>
</div>
<?php } ?>

<?php if($littlenews['related']) { ?>
<?php if(is_array($littlenews['related'])) { foreach($littlenews['related'] as $appid => $values) { ?>
<div class="sidebox">
...
resizeImg('littlenews_article','700');
