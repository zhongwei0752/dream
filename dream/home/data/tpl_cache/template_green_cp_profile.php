<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_profile|template/green/header|template/green/cp_header|template/green/footer', '1370022341', 'template/green/cp_profile');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
