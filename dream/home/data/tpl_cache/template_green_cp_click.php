<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_click|template/green/header|template/green/space_click|template/green/footer', '1370027939', 'template/green/cp_click');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
