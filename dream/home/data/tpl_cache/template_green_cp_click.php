<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_click|template/green/header|template/green/space_click|template/green/footer', '1369496257', 'template/green/cp_click');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
