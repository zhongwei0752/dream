<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/do_login|template/green/header|template/green/footer', '1369410493', 'template/green/do_login');?><?php $_TPL['nosidebar']=1; ?>
