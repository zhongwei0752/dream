<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_blog_view|template/green/header|template/green/space_menu|template/green/space_click|template/green/space_comment_li|template/green/footer', '1369983423', 'template/green/space_blog_view');?><?php $_TPL['titles'] = array($blog['subject'], '日志'); ?>
