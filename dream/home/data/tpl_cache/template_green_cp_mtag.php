<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_mtag|template/green/header|template/green/footer', '1370023889', 'template/green/cp_mtag');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<h2 class="title"><img src="image/icon/mtag.gif" />群组 - <?=$mtag['tagname']?></h2>
