<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_friend|template/green/header|template/green/space_menu|template/green/space_list|template/green/footer', '1368859064', 'template/green/space_friend');?><?php $_TPL['titles'] = array('好友'); ?>
