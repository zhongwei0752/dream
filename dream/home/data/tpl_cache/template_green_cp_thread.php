<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_thread|template/green/header|template/green/cp_topic_menu|template/green/footer|template/green/space_topic_inc', '1370023907', 'template/green/cp_thread');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
