<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_medicine|template/green/header|template/green/footer', '1369992232', 'template/green/cp_medicine');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
