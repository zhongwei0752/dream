<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_mtag_list|template/green/header|template/green/footer', '1369986759', 'template/green/space_mtag_list');?><?php $_TPL['titles'] = array($mtag['tagname'], $mtag['title'], '讨论区'); ?>
...
<?php if(!$mtag) { ?><td class="mtag">群组</td><?php } ?>
...
<?php if(!$mtag) { ?><td class="mtag"><a href="space.php?do=mtag&tagid=<?=$value['tagid']?>"><?=$value['tagname']?></a></td><?php } ?>
