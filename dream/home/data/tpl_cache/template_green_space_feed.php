<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_feed|template/green/header|template/green/space_status|template/green/space_menu|template/green/space_feed_li|template/green/space_feed_li|template/green/space_feed_li|template/green/footer', '1369193727', 'template/green/space_feed');?><?php if(empty($_TPL['getmore'])) { ?>	
