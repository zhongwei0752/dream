<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_littlenews|template/green/header|template/green/cp_topic_menu|template/green/footer|template/green/space_topic_inc', '1369387390', 'template/green/cp_littlenews');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
