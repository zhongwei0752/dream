<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/album|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/green/header|template/green/footer', '1369056253', 'admin/tpl/album');?><?php $_TPL['menunames'] = array(
		'index' => '管理首页',
		'config' => '站点设置',
		'privacy' => '隐私设置',
		'usergroup' => '用户组',
...
<input type="<?php if($allowbatch) { ?>checkbox<?php } else { ?>radio<?php } ?>" name="ids[]" value="<?=$value['albumid']?>"> 选择
</td>
<td>
...
<?php } ?>
<br />时间: <?php echo sgmdate('Y-m-d',$value[dateline]); ?>
<?php if($value['friend']) { ?><br />权限: [<a href="admincp.php?ac=album&friend=<?=$value['friend']?>"><?=$value['friend']?></a>]<?php } ?>
