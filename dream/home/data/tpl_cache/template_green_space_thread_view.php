<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_thread_view|template/green/header|template/green/space_click|template/green/space_post_li|template/green/footer', '1369986754', 'template/green/space_thread_view');?><?php $_TPL['titles'] = array($thread['subject'], $mtag['tagname'], $mtag['title'], '话题'); ?>
