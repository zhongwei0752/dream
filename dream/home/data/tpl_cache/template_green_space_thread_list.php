<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_thread_list|template/green/header|template/green/space_menu|template/green/footer', '1370027567', 'template/green/space_thread_list');?><?php $_TPL['titles'] = array('群组话题'); ?>
