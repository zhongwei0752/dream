<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_event_list|template/green/header|template/green/space_menu|template/green/footer', '1369050383', 'template/green/space_event_list');?><?php $_TPL['titles'] = array('活动'); ?>
