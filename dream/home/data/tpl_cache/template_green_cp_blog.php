<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_blog|template/green/header|template/green/cp_topic_menu|template/green/footer|template/green/space_topic_inc', '1369494869', 'template/green/cp_blog');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
