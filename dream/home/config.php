...
define('UC_DBNAME', 'dream'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`dream`.uc_'); // UCenter 数据库表前缀
...
define('UC_API', 'http://localhost/dream/dream/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
